...
class SellData {
	...
	public function add(){
		$sql = "insert into ".self::$tablename." (ref_id,person_id,stock_to_id,iva,p_id,d_id,total,discount,cash,user_id,created_at) ";
		$sql .= "value ($this->ref_id,$this->person_id,$this->stock_to_id,$this->iva,$this->p_id,$this->d_id,$this->total,$this->discount,$this->cash,$this->user_id,$this->created_at)";
	...
	public function add_re(){
		$sql = "insert into ".self::$tablename."(ref_id,person_id,stock_to_id,total,p_id,d_id,user_id,operation_type_id,created_at) ";
		$sql .= "value ($this->ref_id, $this->person_id,$this->stock_to_id,$this->total,$this->p_id,$this->d_id,$this->user_id,1,$this->created_at)";
		return Executor::doit($sql);
	}
