    ...
    <div class="col-md-12">
      ...
      <form class="form-horizontal" method="post" id="addproduct" enctype="multipart/form-data" action="index.php?action=profile_update" role="form">
        ...
        <div class="form-group">
          ...
          <div class="col-md-3">
            <input type="text" name="lastname" value="<?php echo $user->lastname;?>" readonly class="form-control" id="lastname" placeholder="Apellidos">
          </div>
        </div>
        <div class="form-group">
          <label for="inputEmail1" class="col-lg-2 control-label">Usuario*</label>
          <div class="col-md-3">
            <input type="text" name="dni" value="<?php echo $user->dni;?>" class="form-control" readonly id="dni" placeholder="Nombre de usuario">
          </div>
        ...
        <div class="form-group">
          ...
          <div class="col-md-3">
            <input type="text" name="celular" value="<?php echo $user->celular;?>" class="form-control" id="celular" placeholder="Nombre de usuario">
          </div>
        </div>
        <div class="form-group">
